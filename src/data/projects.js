...
export const blaSolProject = {
  ...
  process: [
    { title: "DISCOVER", image: blaSolImage, imageAlt: "Blå Sol festival research", text: "We explored the challenges festival visitors face around navigation, communication and safety. Through desk research, segmentation, field research, interviews and observation, we investigated how people behave in crowded festival environments and what they need to feel informed and connected." },
    { title: "DEFINE", image: blaSolImage, imageAlt: "Blå Sol audience definition", text: "We structured our findings using empathy maps, affinity diagramming and personas to identify recurring needs and pain points. This helped us define the core opportunity: creating a simple mobile solution that reduces confusion and helps festival guests navigate, stay connected and feel safe." },
    { title: "DEVELOP", image: blaSolImage, imageAlt: "Blå Sol wireframes", text: "We explored different ideas through sketches, moodboards, style tiles and information architecture. We developed the festival map, navigation and communication features while applying UX principles to create a clear and accessible experience." },
    { title: "DELIVER", image: blaSolImage, imageAlt: "Blå Sol final prototype", text: "We tested the concept with 10 participants from the target group and used their feedback to refine the experience. The final solution was developed as an interactive Figma prototype and further implemented as a front-end prototype, bringing together navigation, communication, safety and real-time festival information." },
  ],
};
...
export const spilcafeenProject = {
  ...
  process: [
    { title: "DISCOVER", image: spilcafeenImage, imageAlt: "Spilcafeen research", text: "We explored the experience of choosing board games at Spilcafeen through desk research, observations, and semi-structured interviews. Our research focused on understanding how visitors choose games, what makes the process difficult, and how the large game collection can feel overwhelming." },
    { title: "DEFINE", image: spilcafeenImage, imageAlt: "Spilcafeen audience definition", text: "We used audience segmentation, personas, a Rich Picture, user story mapping, and OOUX to structure our findings and identify the key needs of visitors. This led us to focus on making it easier for guests to quickly discover games that match their group, interests, and experience level." },
    { title: "DEVELOP", image: spilcafeenImage, imageAlt: "Spilcafeen interface development", text: "We translated our research insights into user flows, task flows, sketches, wireframes, and a visual design system. We explored features such as personalized game recommendations, clear game information, and tutorial videos, while applying UX principles to make the experience simple and intuitive." },
    { title: "DELIVER", image: spilcafeenImage, imageAlt: "Spilcafeen final prototype", text: "We developed the concept into a high-fidelity Figma prototype and tested the experience with users through guerrilla testing and five-second tests. The feedback helped us refine the interface and interactions, resulting in a digital experience that makes discovering the right board game faster, easier, and more enjoyable." },
  ],
};
...
export const hiddenHyggeProject = {
  ...
  process: [
    { title: "DISCOVER", image: hyggeImage, imageAlt: "Hidden Hygge Places research", text: "I explored how young adults experience hygge and what makes a place feel cozy, comfortable and worth visiting. Through desk research, observations and interviews, I looked into Danish hygge culture, preferred activities, and how people experience hygge both at home and outside. This helped me understand what creates a meaningful and memorable hygge experience." },
    { title: "DEFINE", image: hyggeImage, imageAlt: "Hidden Hygge Places persona", text: "I defined young adults aged 20–25 as my primary target audience and used my research to identify their needs and motivations. Through an affinity diagram, empathy map, persona and Value Proposition Canvas, I discovered that users value calm, enjoyable experiences and meaningful moments they can remember. This led me to focus on the idea of memorabilia — creating something that allows users to take a small part of the experience with them." },
    { title: "DEVELOP", image: hyggeImage, imageAlt: "Hidden Hygge Places wireframes", text: "I explored how the idea of memorabilia could become part of the digital experience. Through mind mapping, user journeys, task flows and sketching, I developed an interactive quiz that helps users find a hidden hygge location matching their mood and interests. The experience was designed not only to help users discover a place, but to encourage them to create a personal memory connected to that experience." },
    { title: "DELIVER", image: hyggeImage, imageAlt: "Hidden Hygge Places final design", text: "I developed the solution through low-fi, mid-fi and hi-fi prototypes in Figma, refining the layout, content and interactions along the way. Usability testing helped me identify areas for improvement and validate the experience with users. The final responsive website combines personalised location discovery with the idea of creating memorable moments, bringing the concept to life through HTML, CSS and JavaScript." },
  ],
};
